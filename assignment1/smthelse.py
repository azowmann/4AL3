...
# Loop through the combinations of alpha and iteration counts
...
# Print all 25 regression lines with learning rates, iterations, beta values, and MSE
for idx, (alpha, iter_count, beta) in enumerate(final_betas):  # Iterate through all 25 combinations
...
ax.set_title("Gradient Descent Regression Lines - GDP vs Happiness")
